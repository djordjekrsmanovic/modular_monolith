using Booking.AccommodationNS.Application.Features.AccommodationNS.AddAccommodation;
using Booking.AccommodationNS.Application.Features.Accommodations.AddAvailabilityPeriod;
using Booking.AccommodationNS.Application.Features.Accommodations.DeleteAvailabilityPeriod;
using Booking.AccommodationNS.Application.Features.Accommodations.EditAccommodation;
using Booking.AccommodationNS.Application.Features.Accommodations.GetAccommodation;
using Booking.AccommodationNS.Application.Features.Accommodations.GetAccommodationAvailabilityPeriod;
using Booking.AccommodationNS.Application.Features.Accommodations.GetAccommodationById;
using Booking.AccommodationNS.Application.Features.Accommodations.GetAdditionalServices;
using Booking.AccommodationNS.Application.Features.Accommodations.GetHostAccommodations;
