...
namespace CommerceModuleArchitectureTests
{
    public class DomainTests : BaseTest
    {
        ...
        public void Domain_ShoulNotHave_Dependencis_OnOtherProjects()
        {
            ...
            var testResult = Types.InAssembly(CommerceDomainAssembly).ShouldNot().HaveDependencyOnAny(otherProjects).GetResult();
        ...
        public void DomainEvents_Should_BeSealed()
        {
            ...
            var result = Types.InAssembly(CommerceDomainAssembly)
                .That()
        ...
        {
            var entityTypes = Types.InAssembly(CommerceDomainAssembly)
                                    .GetTypes()
